    ...
    <section className={styles.partners__section}>
      <div className={styles.partners__container}>
        ...
        <article className={styles.partners__article}>
          ...
          ведущими предприятиями общественного питания и крупнейшими розничными
          сетями, что позволяет нам стабильно проходить независимый аудит и
          укреплять партнерские отношения с ключевыми дистрибьюторами в
          различных регионах.
        </article>
        <div className={styles.partners__slider}>
          <SliderPartnersBlock content={partnersImages} />
        </div>
      </div>
    </section>
  );
